...
export type ProduceBlindedBlock = {executionPayloadValue: Wei} & {
...
export type ProduceFullOrBlindedBlockOrContentsRes =
  ...
  | (ProduceBlindedBlock & {executionPayloadBlinded: true});
...
export type Api = {
  ...
  produceBlindedBlock(
    ...
    ApiClientResponse<
      {
        [HttpStatusCode.OK]: ProduceBlindedBlock;
      },
      HttpStatusCode.BAD_REQUEST | HttpStatusCode.SERVICE_UNAVAILABLE
    >
  >;
...
export function getReturnTypes(): ReturnTypes<Api> {
  ...
  const produceBlindedBlock = WithExecutionPayloadValue(
  ...
  ) as TypeJson<ProduceBlindedBlock>;
